...
class TemplateHelper
{
    public static function all()
    {
        ...
        $data = array_merge($dataDefault, config('custom-template.custom'));
        ...
        $allOptions = [
            ...
            'defaultLanguage'=>array('ru' => 'en','pt' => 'pt','fr' => 'fr','de' => 'de'),
        ...
        foreach ($allOptions as $key => $value) {
            if (gettype($data[$key]) === gettype($dataDefault[$key])) {
                ...
                if (is_string($dataDefault[$key])) {
                    ...
                    is_string($data[$key]) ? $data[$key] = $dataDefault[$key] : null;
                }
            }
        }
