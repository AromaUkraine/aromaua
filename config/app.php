...
return [
    ...
    */
    ...
    'url_suffix' => env('URL_SUFFIX', null),
    ...
    */
    ...
    'fallback_locale' => env('FALLBACK_LOCALE', 'ru'),

    /*
     |
     |-------------------------------------
     | Application CMS Locale
     |-------------------------------------
     | Локаль админ-зоны по умолчанию
     */
    ...
    'softDelete' => env('APP_SOFT_DELETE', false),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This parameter specifies which file manager will be used
    | available two types filemanager
    | lfm - laravel-filemanager
    | rfm - responsive filemanager
    */
    ...
    */
    ...
    'providers' => [
        ...
        App\Providers\PermissionsBladeServiceProvider::class,
        App\Providers\ObserveServiceProvider::class,
        App\Providers\ComposerServiceProvider::class,
        App\Providers\LocalizationServiceProvider::class,
        App\Providers\LanguagesServiceProvider::class,
    ...
    */
    ...
    'aliases' => [
        ...
        'Breadcrumbs' => App\View\Components\Cms\Page\Breadcrumbs::class
