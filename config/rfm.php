...
$config = array(
    ...
    */
    ...
    //'base_url' => 'http://cms-laravel.loc',//((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . @$_SERVER['HTTP_HOST'],
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'relative_path_from_current_pos'          => array( '../thumbs/300x200/', '../thumbs/400x300/' ,'../thumbs/500x400/'), //relative path of the image folder from the current position on upload folder
    ...
    'relative_image_creation_width'           => array( 300, 400 , 500), //width of image
    'relative_image_creation_height'          => array( 200, 300 , 400), //height of image
    /*
     * $option:     0 / exact = defined size;
     *              1 / portrait = keep aspect set height;
     *              2 / landscape = keep aspect set width;
     ...
     *              4 / crop= resize and crop;
     */
    'relative_image_creation_option'          => array( 'crop', 'crop' , 'crop'), //set the type of the crop
