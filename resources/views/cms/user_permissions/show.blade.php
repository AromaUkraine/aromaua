...
{{ \Breadcrumbs::make([
    'items' =>[
        ...
        ['name'=>'admin.user.index','slug'=>'admin.administration.index' ],
...
@section('content')
    <div class="row">
        <div class="col-12" >
            <x-form expand options="{!! json_encode(['route' => ['admin.user_permissions.update', $user->id],  'method'=>'patch']) !!} ">
                ...
                @section('form-fixed-buttons')
                    ...
                    <x-action
                            href="{{ route('admin.administration.index') }}"
                            class="light text-capitalize mr-1 my-2"
